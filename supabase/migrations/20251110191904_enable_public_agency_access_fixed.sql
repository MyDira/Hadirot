/*
  # Enable Public Access to Agency Pages (Fixed)

  ## Overview
  This migration allows anyone (authenticated or anonymous) to view agency pages
  by replacing the restrictive SELECT policy with a public one. This enables sharing
  ...
  ## Changes
  1. Drop the old restrictive agencies_select policy
  2. Add new public SELECT policy for agencies table
  3. Keep all existing INSERT/UPDATE/DELETE policies unchanged
*/
