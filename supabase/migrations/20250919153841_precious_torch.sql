/*
  # Fix Agency Slugification and Ownership
  ...
  2. Security
    ...
    - Maintain proper search_path and SECURITY DEFINER settings
...
-- Ensure insert trigger function is properly defined (hygiene check)
