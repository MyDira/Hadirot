/*
  ...
  1. Function Updates
    - Fix `analytics_kpis` function to return correct integer types instead of bigint
    - Cast COUNT() results to integer to match function signature
  
  2. Changes
    - Update return type casting in analytics_kpis function
    - Ensure all COUNT() operations return integer type as expected
*/
