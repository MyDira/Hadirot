...
export function ListingFilters({ filters, onFiltersChange, agencies, allNeighborhoods, isMobile = false }: ListingFiltersProps) {
  ...
  return (
    <div className={`bg-[#FBF8F3] p-4 rounded-lg shadow-sm border border-gray-200 ${!isMobile ? 'mb-6' : ''}`}>
      ...
      <div className={`grid gap-4 ${isMobile ? 'grid-cols-1' : 'grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-7'}`}>
        ...
        <div>
          ...
          <div className="relative">
            <div
              className="w-full px-3 py-2 border border-gray-300 rounded-md focus-within:ring-[#273140] focus-within:border-[#273140] h-10 cursor-pointer bg-[#FBF8F3] flex items-center justify-between"
            ...
            {showNeighborhoodDropdown && (
              <div className="absolute z-10 w-full mt-1 bg-[#FBF8F3] border border-gray-300 rounded-md shadow-lg max-h-60 overflow-y-auto">
