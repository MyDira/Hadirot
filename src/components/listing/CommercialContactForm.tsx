...
export function CommercialContactForm({ commercialListingId, onSuccess }: CommercialContactFormProps) {
  ...
  const validateForm = (): boolean => {
    const errors = { userName: '', userPhone: '' };
    let isValid = true;
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      console.error('Error submitting commercial contact form:', err);
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-4">
      <div>
        <label htmlFor="commercial-userName" className="block text-sm font-medium text-gray-700 mb-1">
          Your Name
        </label>
        <input
          type="text"
          id="commercial-userName"
      ...
      <div>
        <label htmlFor="commercial-userPhone" className="block text-sm font-medium text-gray-700 mb-1">
          Your Phone Number
        </label>
        <input
          type="tel"
          id="commercial-userPhone"
