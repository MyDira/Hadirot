...
export function Step3SaleShowItOff({
  formData,
  updateFormData,
  onNext,
  onBack,
    ...
    <div className="flex gap-8 items-start">
      <div className="flex-1 min-w-0 space-y-5">
        <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
          ...
          <p className="text-sm text-gray-500 mb-5">Required — at least 1 photo for sale listings</p>
          ...
          <div className="space-y-4">
            <div>
              ...
              <input
                ...
                placeholder="e.g. Stunning 4BR Single-Family in Midwood"
                maxLength={120}
            ...
            <div>
              ...
              <textarea
                ...
                rows={6}
                placeholder="Describe the property — layout, finishes, recent upgrades, neighborhood, schools, transit…"
