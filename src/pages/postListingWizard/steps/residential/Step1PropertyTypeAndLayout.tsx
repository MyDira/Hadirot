...
interface Step1Props {
  ...
  onNext: () => void;
  onBack: () => void;
  /** When true (residential rental, edit context, >10d old), bedrooms is locked. */
  isLocked?: boolean;
}

export function Step1PropertyTypeAndLayout({ formData, updateFormData, onNext, onBack, isLocked = false }: Step1Props) {
