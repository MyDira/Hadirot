...
export type PropertyType = 'apartment_building' | 'apartment_house' | 'full_house' | 'duplex' | 'basement' | 'detached_house' | 'semi_attached_house' | 'fully_attached_townhouse' | 'condo' | 'co_op' | 'single_family' | 'two_family' | 'three_family' | 'four_family';
export type ParkingType = 'yes' | 'included' | 'optional' | 'no' | 'carport';
export type HeatType = 'included' | 'tenant_pays';
export type LeaseLength = 'short_term' | 'long_term_annual' | 'summer_rental' | 'winter_rental';
...
export type CommercialSpaceType = 'storefront' | 'restaurant' | 'office' | 'warehouse' | 'industrial' | 'mixed_use' | 'community_facility' | 'basement_commercial';
export type CommercialSubtype = 'medical_office' | 'creative_loft' | 'coworking' | 'distribution' | 'cold_storage' | 'strip_center' | 'showroom' | 'bar_lounge' | 'cafe' | 'rd_lab' | 'data_center' | 'daycare' | 'religious' | 'freestanding';
export type LeaseType = 'nnn' | 'gross' | 'modified_gross' | 'full_service' | 'percentage' | 'industrial_gross' | 'absolute_net' | 'tenant_electric';
export type BuildOutCondition = 'full_build_out' | 'turnkey' | 'second_generation' | 'vanilla_box' | 'shell' | 'cold_dark_shell';
export type BuildingClass = 'a' | 'b' | 'c';
export type TenancyType = 'single_tenant' | 'multi_tenant' | 'vacant';
