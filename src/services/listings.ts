...
export const listingsService = {
  ...
  async updateListing(id: string, payload: Partial<ListingCreateInput>) {
    ...
    // Owners (and admins) may edit any field of their listing at any time —
    // there is no field lock. The former 10-day residential-rental lock on
    // bedrooms/neighborhood/location/address/coords/phone has been removed.
